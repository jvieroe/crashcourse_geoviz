...
Det er smart, fordi det frigør lidt plads til at visualisere flere dimensioner i data ved hjælp af farve, størrelse osv. ('aesthetics')
...
* "Spatial data" er basically alt data, hvor observationer har en form for fysisk placering/relation ift. hinanden
...
* Klassiske eksempler på spatialt data er digitaliserede kort over landegrænser, landbrugsafkast, vejnetværk, metrostationer osv.


## Hvordan arbejder vi med spatialt data?

* Når vi skal arbejde med spatiale datasæt
