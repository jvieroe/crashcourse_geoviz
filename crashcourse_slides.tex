...
\begin{itemize}
\item
  Lad os kigge på det og loade et datasæt over danske kommuner
\item
  Typisk vil spatialt data ligge gemt som shapefiles eller som
  geojson-filer
\end{itemize}
...
\includegraphics{crashcourse_slides_files/figure-beamer/unnamed-chunk-16-1.pdf}
